...
import com.hackorange.pixify.dao.ArticleTagDao;
import com.hackorange.pixify.dao.CategoryDao;
import com.hackorange.pixify.dao.TagDao;
import com.hackorange.pixify.dto.*;
import com.hackorange.pixify.entity.Article;
import com.hackorange.pixify.entity.ArticleTag;
import com.hackorange.pixify.entity.Category;
import com.hackorange.pixify.entity.Tag;
import com.hackorange.pixify.enums.FileExtEnum;
import com.hackorange.pixify.enums.FilePathEnum;
import com.hackorange.pixify.exception.BizException;
import com.hackorange.pixify.service.*;
import com.hackorange.pixify.strategy.context.SearchStrategyContext;
import com.hackorange.pixify.strategy.context.UploadStrategyContext;
import com.hackorange.pixify.util.BeanCopyUtils;
import com.hackorange.pixify.util.CommonUtils;
...
import static com.hackorange.pixify.constant.CommonConst.ARTICLE_SET;
...
import static com.hackorange.pixify.enums.ArticleStatusEnum.DRAFT;
import static com.hackorange.pixify.enums.ArticleStatusEnum.PUBLIC;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleDao, Article> implements ArticleService {
    ...
    public ArticleDTO getArticleById(Integer articleId) {
        ...
        Article article1 = baseMapper.selectById(articleId);
        Article one = lambdaQuery().select(Article::getId, Article::getArticleTitle,
                        Article::getArticleCover)
                .eq(Article::getIsDelete, FALSE)
                .eq(Article::getStatus, PUBLIC.getStatus())
                .lt(Article::getId, articleId)
                .orderByDesc(Article::getId).last("limit 1").one();
